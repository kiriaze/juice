...
!function(t){"use strict";window.THEMENAME={};{var i=window.THEMENAME,e=t(window);t(document.body),t(document.documentElement)}i.init=function(){i.setElements(),i.colors(),i.basics(),i.accordions(),i.tabs(),i.toggles(),i.alerts(),i.tooltips()},i.setElements=function(){i.elems={},i.elems.html=t("html"),i.elems.body=t("body"),i.elems.scrollToTop=t('a[data-scroll-to="top"]'),i.elems.tooltip=t("[data-toggle=tooltip]"),i.elems.tab=t("[data-tab]"),i.elems.toggles=t(".simple-toggle"),i.elems.accordions=t(".simple-accordion")},i.colors=function(){},i.basics=function(){t("body").simpleforms(),t.simpleAnchors({offset:-1,easing:"easeInOutCubic"}),t(".bg-image").each(function(){var i=t(this).data("background");t(this).append(t("<img>").attr("src",i))}),i.elems.body.fitVids()},i.accordions=function(){t(".accordion").accordion({header:".simple-accordion-title",collapsible:!0,heightStyle:"content"});var e=i.elems.accordions.find(".ui-icon");e.addClass("ion-plus"),i.elems.accordions.find(".simple-accordion-title").is(".ui-state-active")&&t(".ui-state-active").find(e).addClass("ion-minus"),i.elems.accordions.on("click",function(){e.removeClass("ion-minus").addClass("ion-plus"),t(this).find(".simple-accordion-title").is(".ui-state-active")&&t(this).find(e).removeClass("ion-plus").addClass("ion-minus")})},i.tabs=function(){var e=t('[data-type="tabs"]');e.find("[data-tab-content]:first-of-type").addClass("active"),e.find("[data-tab]:first-of-type").addClass("active"),i.elems.tab.on("click",function(i){i.preventDefault(),t(this).is(".active")||t(this).addClass("active").siblings("[data-tab]").removeClass("active").siblings('[data-tab-content="'+t(this).data("tab")+'"]').addClass("active").siblings("[data-tab-content]").removeClass("active")})},i.toggles=function(){i.elems.toggles.each(function(){t(this).accordion("closed"===t(this).attr("data-id")?{header:".simple-toggle-title",collapsible:!0,active:!1}:{header:".simple-toggle-title",collapsible:!0})});var e=i.elems.toggles.find(".ui-icon");e.addClass("fa fa-angle-down"),i.elems.toggles.find(".simple-toggle-title").is(".ui-state-active")&&t(".ui-state-active").find(e).addClass("fa-angle-up"),i.elems.toggles.on("click",function(){t(this).find(".simple-toggle-title").is(".ui-state-active")?t(this).find(e).removeClass("fa-angle-down").addClass("fa-angle-up"):t(this).find(e).removeClass("fa-angle-up").addClass("fa-angle-down")})},i.alerts=function(){t(".alert .close").click(function(){t(this).parent(".alert").fadeTo(300,.001).slideUp()})},i.tooltips=function(){i.elems.tooltip.hover(function(){var i=t(this),e=i.attr("title"),s=i.data("placement"),a=t('<div class="tooltip '+s+'"><div class="tooltip-arrow"></div><div class="tooltip-inner">'+e+"</div></div>");i.append(t(a)),"top"===s&&a.css({top:-a.height()-10,"margin-left":-a.width()/2}),"bottom"===s&&a.css({"margin-left":-a.width()/2}),"left"===s&&a.css({top:-a.height()/4,left:-a.width()-20}),"right"===s&&a.css({top:-a.height()/4,right:-a.width()-20}),a.addClass("in")},function(){t(this).find(".tooltip").removeClass("in").remove()})},e.load(function(){}),e.resize(function(t){}),t(document).ready(function(){i.init()})}(window.jQuery);
...
!function(s,e,t,i){function n(e,t){this.element=e,this.settings=s.extend({},c,t),this._defaults=c,this._name=a,this.init()}var a="simpleforms",c={};n.prototype={init:function(){{var s=this;s.settings}s.setup_simpleforms()},setup_simpleforms:function(e){{var t=this;t.settings}s('.simpleforms input[type="checkbox"]').each(function(){s(this).hasClass("toggler")?(s(this).wrap('<span class="sf-toggler"></span>'),s(this).is(":checked")&&s(this).parents(".sf-toggler").addClass("checked")):(s(this).wrap('<span class="sf-checkbox"></span>'),s(this).is(":checked")&&s(this).parents(".sf-checkbox").addClass("checked"))}),s(".sf-toggler").prepend('<span class="handle"></span>'),s('.simpleforms input[type="radio"]').each(function(){s(this).wrap('<span class="sf-radio"></span>'),s(this).is(":checked")&&s(this).parents(".sf-radio").addClass("checked")}),s(".simpleforms select").each(function(){s(this).wrap('<span class="sf-select"></span>')}),s(".simpleforms").find(".file-select").each(function(){var e=s(this),t=e.parents(".file-label"),i=t.find(".file-input"),n=t.find(".preview-file"),a=t.find(".file-name"),c=t.find(".remove-file");c.hide(),e.on("click",function(s){s.preventDefault(),i.trigger("click")}),i.change(function(){var s=e.val(),t=s.length?s.split("\\").pop():"";if(a.html(t),c.show(),this.files&&this.files[0]){var i=new FileReader;i.onload=function(s){n.attr("src",s.target.result)},i.readAsDataURL(this.files[0])}}),c.on("click",function(s){s.preventDefault(),i.wrap("<form>").closest("form").get(0).reset(),i.unwrap(),n.attr("src","data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D")})})}},s(t).on("change",'.simpleforms input[type="radio"]',function(){var e=s(this).attr("name");s('input[name="'+e+'"]').parents(".sf-radio").removeClass("checked"),s(this).parents(".sf-radio").toggleClass("checked")}),s(t).on("click",".simpleforms .sf-checkbox, .simpleforms .sf-toggler",function(){var e=s(this).find('input[type="checkbox"]');s(this).hasClass("checked")?e.removeAttr("checked"):e.attr("checked","checked"),s(this).toggleClass("checked")}),s.fn[a]=function(e){var t;return this.each(function(){t=s.data(this,"plugin_"+a),t||(t=new n(this,e),s.data(this,"plugin_"+a,t))}),t}}(jQuery,window,document);
